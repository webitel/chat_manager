...
func MapChannelToAppChannel(channel *sqlxrepo.Channel) (*app.Channel, error) {
...
func MapInputMessageToMessage(inputMessage *pbmessages.InputMessage) (*pbchat.Message, error) {
