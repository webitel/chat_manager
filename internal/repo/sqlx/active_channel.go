...
func (repo *sqlxRepository) GetActiveChannelByID(ctx context.Context, id string) (*Channel, error) {
	result := &Channel{}
...
func (repo *sqlxRepository) GetActiveChannels(
	ctx context.Context,
	userID *int64,
...
func (repo *sqlxRepository) CreateActiveChannel(ctx context.Context, c *Channel) error {
...
func (repo *sqlxRepository) CloseActiveChannel(ctx context.Context, id string) (*Channel, error) {
	result := &Channel{}
	err := repo.db.GetContext(ctx, result, "SELECT * FROM chat.channel WHERE id=$1", id)
	if err != nil {
		repo.log.Warn().Msg(err.Error())
...
func (repo *sqlxRepository) CloseActiveChannels(ctx context.Context, conversationID string) error {
...
func (repo *sqlxRepository) CheckActiveUserChannel(ctx context.Context, channelID string, userID int64) (*Channel, error) {
	result := &Channel{}
...
func (repo *sqlxRepository) UpdateActiveChannel(ctx context.Context, channelID string) (int64, error) {
	updatedAt := time.Now()
