...
var file_chat_messages_contacts_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x6d, 0x65, 0x32, 0xa5, 0x03, 0x0a, 0x15, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74,
	...
	0x4e, 0x41, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x39, 0x5a, 0x37,
...
var file_chat_messages_contacts_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
func file_chat_messages_contacts_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chat_messages_contacts_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chat_messages_contacts_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Lookup); i {
			case 0:
				return &v.state
			case 1:
