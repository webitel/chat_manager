...
func file_chat_messages_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chat_messages_message_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_chat_messages_message_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*File); i {
			case 0:
				return &v.state
			case 1:
		...
		file_chat_messages_message_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_chat_messages_message_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_chat_messages_message_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Button); i {
			case 0:
				return &v.state
			case 1:
		...
		file_chat_messages_message_proto_msgTypes[5].Exporter = func(v any, i int) any {
