...
func file_chat_messages_cases_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chat_messages_cases_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*GetCaseChatHistoryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chat_messages_cases_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*GetCaseChatHistoryRequest_Offset); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
