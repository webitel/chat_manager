...
var file_chat_messages_customer_proto_goTypes = []interface{}{
...
func file_chat_messages_customer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chat_messages_customer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chat_messages_customer_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChatCustomers); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chat_messages_customer_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChatCustomersRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
